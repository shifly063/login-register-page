    ...
    <div className="grid h-screen place-items-center">
        <div class="p-4 w-full max-w-lg bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form class="space-y-8" action="#">
                <div class= "text-2xl text-gray-900 text-center dark:text-white font-semibold">
                    <h2 ><span className="text-blue-300">Login </span>Page</h2>
                </div>
                <h5 class="text-xl font-medium text-gray-900 text-center dark:text-white">Sign In Your Account</h5>
                <div>
                ...
                <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-500 dark:hover:bg-blue-800 dark:focus:ring-blue-500">Login</button>
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    don't have an account? <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">Create account</a>
                </div>
            </form>
        </div>
    </div>
